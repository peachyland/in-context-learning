...
class TransformerModel(nn.Module):
    ...
    def _combine3(xs_b, ys_b):
        """Concatenates ys_b to the end of xs_b in each column."""
        
        # Expand the dimensions of ys_b to make it compatible with xs_b
        ys_b_expanded = ys_b.unsqueeze(-1).clone()
       
        ys_b_expanded[:,-1]=0
        # Concatenate ys_b_expanded to the end of xs_b
        combined = torch.cat((xs_b, ys_b_expanded.to('cuda')), dim=-1)
        return combined
    
    # def _combine4(self,xs_b, ys_b,inds):
    #     """Concatenates ys_b to the end of xs_b in each column."""
    ...
    #     else:
    #         xs_b[:,inds.item()+1:,:]=0
    #         ys_b_expanded[:,inds.item():]=0
    #     # Concatenate ys_b_expanded to the end of xs_b
    #     combined = torch.cat((xs_b, ys_b_expanded), dim=-1)
    #     return combined
