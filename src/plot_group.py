...
# correlated
# no read in ['1', '2', '3', '6'] [221, 222, 223, 227]
# emb6 ['1', '2', '3', '6'] [250, 228, 229, 252]
# emb64 ['1', '8', '16', '64'] [261, 262, 263, 264]
# emb128 ['1', '8', '16', '64', '128'] [265, 266, 267, 268, 269] 
# emb256 ['1', '8', '16', '64', '128', '256'] [270, 271, 272, 273, 274, 275]
# fixed head each emb 8 ['1', '8', '16', '32'], 
# head 1 ['0.01', '0.05', '0.1', '0.5', '1'], 
# head 16 ['0.01', '0.05', '0.1', '0.5', '1'], 
...
if args.job_by_list:
    target_jobid = [f"jobid{job_id}" for job_id in [110, 46, 112, 47, 48, 49]] # emb64: [39, 40, 51, 41]
else:
    target_jobid = [f"jobid{job_id}" for job_id in range(start_id, end_id+1)]
